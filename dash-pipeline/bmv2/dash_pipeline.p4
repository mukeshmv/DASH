...
#define ACL_GROUPS_PARAM(prefix) \
    bit<16> ## prefix ##_stage1_acl_group_id, \
    bit<16> ## prefix ##_stage2_acl_group_id, \
    bit<16> ## prefix ##_stage3_acl_group_id, \
    bit<16> ## prefix ##_stage4_acl_group_id, \
    bit<16> ## prefix ##_stage5_acl_group_id

#define ACL_GROUPS_COPY_TO_META(prefix) \
   meta.stage1_acl_group_id = ## prefix ##_stage1_acl_group_id; \
   meta.stage2_acl_group_id = ## prefix ##_stage2_acl_group_id; \
   meta.stage3_acl_group_id = ## prefix ##_stage3_acl_group_id; \
   meta.stage4_acl_group_id = ## prefix ##_stage4_acl_group_id; \
   meta.stage5_acl_group_id = ## prefix ##_stage5_acl_group_id;
    ...
    table acl_group {
        key = {
            meta.stage1_acl_group_id : exact @name("meta.stage1_acl_group_id:dash_acl_group_id");
        }
        actions = {
            set_acl_group_attrs();
        }
